...
const Hero2 = () => {
    return (
        <>
        <div>
         <header className="car2">
          <div className="masthead-content">
              <div className="container px-5">
                  <h2 className="masthead-heading mb-0 mx-3"> <p style={{textAlign:"center"}}><h1><mark style={{backgroundColor:"#cfba98" }}>  Ac section</mark></h1></p> </h2>
 ...
 <div class="container">
  ...
  <div class="row mt-8 col-md-12">
    ...
    <div style={{marginTop:"55px"}} class="col mx-5">
     ...
     <Popup ac="Air Contioner Room" dar="$1000"/>
    </div>
  </div>
